...
# todo: 0612 Firmware website can crawl Dahua and Hikvision firmware: http://www.xiagujian.com/dahuagujian/
class DahuaSpider(scrapy.Spider):
    name = 'dahua'
    pattern = re.compile("DH(?:-[A-Za-z0-9/]+)+")
    allowed_domains = ['supportapi.dahuatech.com']
    # start_urls = ['https://support.dahuatech.com/tools/thePackage/']  # https://www.dahuasecurity.com/support/downloadCenter/firmware?id=111
